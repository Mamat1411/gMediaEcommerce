        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="fs-5">
                        <span>in <a href="/?category={{ $product->category->slug }}" class="text-decoration-none">{{ $product->category->name }}</a></span>
                        <span>By <a href="/?brand={{ $product->brand->slug }}" class="text-decoration-none">{{ $product->brand->name }}</a></span>
                    </div>
                    <div class="fs-5 mb-5">
